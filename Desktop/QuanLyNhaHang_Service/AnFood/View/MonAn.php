	      ...
	      { ?>
			<tr>
			    ...
			    <td  style="text-align: right;">
			    	...
			    	<a class="btn btn-info" href="SuaMonAn.php?id=<?php echo $monan->id; ?>">Sửa</a>


			    	<a href="../Controller/Xoa.php?id=<?php  echo $monan->id; ?>"><button type="button" class="btn btn-info">Xóa</button></a>
